...
public class ModItems
{
    ...
    */
    ...
    public static final RegistryObject<TimelessGunItem> AR15_P = REGISTER.register("ar_15_p", () -> new AutomaticTimelessGunItem(properties -> properties.tab(GunMod.GROUP), Config.SERVER.gunHandlingCustomization.AR15P_trigMax));
