...
public class glock_17_animation implements IOverrideModel {
    ...
    public void render(float v, ItemCameraTransforms.TransformType transformType, ItemStack stack, ItemStack parent, LivingEntity entity, MatrixStack matrices, IRenderTypeBuffer renderBuffer, int light, int overlay) {
        ...
        */
        ...
        if(Glock17AnimationController.getInstance().isAnimationRunning()  &&
                Glock17AnimationController.getInstance().getPreviousAnimation()== Glock17AnimationController.RELOAD_NORM){
            matrices.translate(0, 0, alpha1);
            matrices.translate(0,0,0.1875F);
        ...
        matrices.translate(0.00f, 0.0f, -0.025f);
